...
package cn.zmdx.kaka.fast.locker.settings.config;
...
import cn.zmdx.kaka.fast.locker.settings.CropImageActivity;
    ...
    public static void setAllowFolatWindow(Context mContent, String version) {
        try {
            if (version.equals(MUIU_V5)) {
                Uri packageURI = Uri.parse("package:" + "cn.zmdx.kaka.fast.locker");
