...
public class ButtonFloat extends Button {
    ...
    public ButtonFloat(Context context, AttributeSet attrs) {
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(Utils.dpToPx(sizeIcon,
                getResources()), Utils.dpToPx(sizeIcon, getResources()));
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        post(new Runnable() {
            ...
            @Override
            public void run() {
                showPosition = ViewCompat.getY(ButtonFloat.this) - Utils.dpToPx(24, getResources());
                hidePosition = ViewCompat.getY(ButtonFloat.this) + getHeight() * 3;
                if (animate) {
                    ViewCompat.setY(ButtonFloat.this, hidePosition);
                    show();
                }
            }
        });
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (x != -1) {
            ...
            Rect dst = new Rect(Utils.dpToPx(1, getResources()), Utils.dpToPx(2, getResources()),
                    getWidth() - Utils.dpToPx(1, getResources()), getHeight()
