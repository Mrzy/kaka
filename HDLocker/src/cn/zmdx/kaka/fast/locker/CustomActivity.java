...
public class CustomActivity extends Fragment {
    ...
    Bundle savedInstanceState) {
        ...
        // ContextThemeWrapper(getActivity(),R.style.TransparentTheme);
        // LayoutInflater localInflater =
        // inflater.cloneInContext(contextThemeWrapper);

        // view = localInflater.inflate(R.layout.activity_actionbar, null);
        if (view == null) {
            view = inflater.inflate(R.layout.activity_actionbar, container, false);
        }
        settingItems = new String[] {
                getString(R.string.fast_setting_item_open_fastlocker),
                getString(R.string.fast_setting_item_set_password),
    ...
    private void initView() {
        mRootViewFrameLayout = (FrameLayout) view.findViewById(R.id.actionbar_rootview);
        mLockScreenName = (TextView) view.findViewById(R.id.fastlocker_name);
    ...
    private void setupListView() {
        ...
        SettingItemsAdapter settingItemsAdapter = new SettingItemsAdapter(getActivity(), FAKES);
        ...
        mSpaceView = getActivity().getLayoutInflater().inflate(
                R.layout.activity_actionbar_listview_space, mListView, false);
    ...
    private void gotoLockerPasswordActivity() {
        Intent intentLocker = new Intent(getActivity(), LockerPasswordActivity.class);
        startActivity(intentLocker);
    }

    private void gotoWallpaperActivity() {
        Intent intentWallpaper = new Intent(getActivity(), WallPaperActivity.class);
        startActivity(intentWallpaper);
    }

    private void gotoIndividualizationActivity() {
        Intent intentIndividual = new Intent(getActivity(), IndividualizationActivity.class);
    ...
    private ImageView getActionBarIconView() {
        return (ImageView) view.findViewById(android.R.id.home);
    }
