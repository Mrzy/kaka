...
package cn.zmdx.kaka.locker.swipe;
 ...
 * </p>
 */
public class PandoraSwipeRefreshLayout extends ViewGroup {
    ...
    private static final String LOG_TAG = PandoraSwipeRefreshLayout.class.getSimpleName();
     ...
     * @param context
     */
    public PandoraSwipeRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public PandoraSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
