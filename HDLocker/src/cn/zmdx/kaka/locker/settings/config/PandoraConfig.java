...
public class PandoraConfig {
	...
	private static final String KEY_ONLINE_WALLPAPER = "p";

	private PandoraConfig(Context context) {
		mContext = context;
		mSp = context.getSharedPreferences(SP_NAME_SETTINGS,
	...
	public void saveOnlineWallpaperFileName(String fileName) {
		Editor editor = mSp.edit();
		editor.putString(KEY_ONLINE_WALLPAPER, fileName);
		editor.commit();
	}

	public String getOnlineWallpaperFileName() {
		return mSp.getString(KEY_ONLINE_WALLPAPER, "");
	}
