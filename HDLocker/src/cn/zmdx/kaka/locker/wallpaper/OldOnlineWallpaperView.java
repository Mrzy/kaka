...
public class OldOnlineWallpaperView extends LinearLayout {
    ...
    public OldOnlineWallpaperView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;
        initRootView();
    }

    public OldOnlineWallpaperView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initRootView();
    }

    public OldOnlineWallpaperView(Context context) {
        super(context);
        mContext = context;
        initRootView();
    }
