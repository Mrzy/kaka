...
public class LayoutGenerator4 extends BaseLayoutGenerator {
    ...
    public LayoutGenerator4(Context context) {
        mContext = context;
    ...
    public int getLayoutId() {
        return TimeLayoutManager.LAYOUT_ID4;
    }

    @Override
    protected View createView() {
        View view = LayoutInflater.from(HDApplication.getContext()).inflate(
                R.layout.date_weather_widget_layout4, null);
        ...
        mWeatherCentTemp.setTypeface(tf);
