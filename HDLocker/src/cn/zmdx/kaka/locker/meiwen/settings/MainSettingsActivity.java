...
import cn.zmdx.kaka.locker.meiwen.guide.GuideActivity;
...
//        AppUninstall.openUrlWhenUninstall(this, "http://www.hdlocker.com");
        ...
        setContentView(Res.layout.main_setting_activity);
        getWindow().getAttributes().flags = LayoutParams.FLAG_LAYOUT_IN_SCREEN;
        getSupportFragmentManager().beginTransaction()
                .add(Res.id.content, new MainSettingsFragment()).commit();
    }
