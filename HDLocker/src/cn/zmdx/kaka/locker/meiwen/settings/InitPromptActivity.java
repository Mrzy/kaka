...
public class InitPromptActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(Res.layout.init_prompt_activity);
    ...
    private void initView() {
        if (isMIUI) {
            if (PandoraUtils.MUIU_V6.equals(mMIUIVersion)) {
                findViewById(Res.id.init_setting_close_systemlocker_prompt).setVisibility(View.GONE);
                findViewById(Res.id.init_setting_MIUI_V5).setVisibility(View.GONE);
                findViewById(Res.id.init_setting_MIUI_V6).setVisibility(View.VISIBLE);
                mV6CloseSystemLockerView = (LinearLayout) findViewById(Res.id.init_setting_V6_close_systemlocker_prompt);
                mV6AllowFloatWindowView = (LinearLayout) findViewById(Res.id.init_setting_V6_allow_floating_window_prompt);
                mV6TrustView = (LinearLayout) findViewById(Res.id.init_setting_V6_trust_prompt);
            } else {
                findViewById(Res.id.init_setting_close_systemlocker_prompt).setVisibility(View.GONE);
                findViewById(Res.id.init_setting_MIUI_V5).setVisibility(View.VISIBLE);
                findViewById(Res.id.init_setting_MIUI_V6).setVisibility(View.GONE);
                mV5CloseSystemLockerView = (LinearLayout) findViewById(Res.id.init_setting_V5_close_systemlocker_prompt_miui);
                mV5AllowFloatWindowView = (LinearLayout) findViewById(Res.id.init_setting_V5_allow_floating_window_prompt);
                mV5TrustView = (LinearLayout) findViewById(Res.id.init_setting_V5_trust_prompt);
            }
        } else {
            findViewById(Res.id.init_setting_MIUI_V5).setVisibility(View.GONE);
            findViewById(Res.id.init_setting_MIUI_V6).setVisibility(View.GONE);
            mCloseSystemLockerView = (LinearLayout) findViewById(Res.id.init_setting_close_systemlocker_prompt);
        }
        
        mReadNotificationView = (LinearLayout) findViewById(Res.id.init_setting_read_notification_prompt);
    }
