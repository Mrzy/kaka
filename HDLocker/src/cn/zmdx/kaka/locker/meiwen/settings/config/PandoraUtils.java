...
package cn.zmdx.kaka.locker.meiwen.settings.config;
...
import cn.zmdx.kaka.locker.meiwen.settings.CropImageActivity;
import cn.zmdx.kaka.locker.meiwen.settings.IndividualizationActivity;
...
public class PandoraUtils {
    ...
    public static void closeSystemLocker(Context context, boolean isMIUI) {
        try {
            ...
            Toast.makeText(context, Res.string.error, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public static void setAllowFolatWindow(Context mContent, String version) {
        try {
            ...
            Toast.makeText(mContent, Res.string.error, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public static void setMIUIAllowReadNotification(Context mContext, String version) {
        try {
            ...
            Toast.makeText(mContext, Res.string.error, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public static String getWeekString(Context mContext, int weekInt) {
        ...
        switch (weekInt) {
            case Calendar.MONDAY:
                weekString = mContext.getResources().getString(Res.string.lock_week_monday);
                break;
            case Calendar.TUESDAY:
                weekString = mContext.getResources().getString(Res.string.lock_week_tuesday);
                break;
            case Calendar.WEDNESDAY:
                weekString = mContext.getResources().getString(Res.string.lock_week_wednesday);
                break;
            case Calendar.THURSDAY:
                weekString = mContext.getResources().getString(Res.string.lock_week_thursday);
                break;
            case Calendar.FRIDAY:
                weekString = mContext.getResources().getString(Res.string.lock_week_friday);
                break;
            case Calendar.SATURDAY:
                weekString = mContext.getResources().getString(Res.string.lock_week_saturday);
                break;
            case Calendar.SUNDAY:
                weekString = mContext.getResources().getString(Res.string.lock_week_sunday);
                break;
    ...
    public static void gotoCaptureActivity(Activity activity, int requestCode) {
        try {
            ...
            Toast.makeText(activity, Res.string.error, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public static void gotoCropActivity(Activity activity, Uri uri, int mAspectRatioX,
        ...
        activity.overridePendingTransition(Res.anim.umeng_fb_slide_in_from_right,
    ...
    public static String getTimeQuantumString(Context mContext, int currentHour) {
        ...
        switch (currentQuantum) {
            case WARM_PROMPT_6:
                if (random == 0) {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_6_10_1);
                } else {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_6_10_2);
                }
                break;
            case WARM_PROMPT_10:
                if (random == 0) {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_10_12_1);
                } else {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_10_12_2);
                }
                break;
            case WARM_PROMPT_12:
                if (random == 0) {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_12_13_1);
                } else {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_12_13_2);
                }
                break;
            case WARM_PROMPT_13:
                if (random == 0) {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_13_15_1);
                } else {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_13_15_2);
                }
                break;
            case WARM_PROMPT_15:
                if (random == 0) {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_15_17_1);
                } else {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_15_17_2);
                }
                break;
            case WARM_PROMPT_17:
                if (random == 0) {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_17_19_1);
                } else {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_17_19_2);
                }
                break;
            case WARM_PROMPT_19:
                if (random == 0) {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_19_23_1);
                } else {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_19_23_2);
                }
                break;

            case WARM_PROMPT_23:
                if (random == 0) {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_23_1_1);
                } else {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_23_1_2);
                }
                break;
            case WARM_PROMPT_1:
                if (random == 0) {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_1_6_1);
                } else {
                    promptString = mContext.getResources().getString(Res.string.warm_prompt_1_6_2);
                }
                break;
