...
import cn.zmdx.kaka.locker.meiwen.widget.PandoraLockPatternView;
import cn.zmdx.kaka.locker.meiwen.widget.PandoraLockPatternView.ILockPatternListener;
import cn.zmdx.kaka.locker.meiwen.widget.PandoraNumberLockView;
...
public class LockerPasswordTypeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(Res.layout.pandora_locker_password_type);
    ...
    private void initView() {
        mLockPatternLayout = (LinearLayout) findViewById(Res.id.pandora_lock_pattern_layout);
        mNumberLockLayout = (LinearLayout) findViewById(Res.id.pandora_number_lock_layout);
        switch (curType) {
