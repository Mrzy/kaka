...
public class CropImageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(Res.layout.pandora_crop_image);
        try {
            ...
            Toast.makeText(CropImageActivity.this, getResources().getString(Res.string.error),
    ...
    private void initView() {
        mCropImageView = (CropImageView) findViewById(Res.id.pandora_crop_image);
        mCropImageView.setFixedAspectRatio(true);
        mCropImageView.setImageBitmap(mCropBitmap);
        mCropImageView.setAspectRatio(mAspectRatioX, mAspectRatioY);

        mRotate = (TypefaceTextView) findViewById(Res.id.pandora_rotate_btn);
        ...
        mOK = (TypefaceTextView) findViewById(Res.id.pandora_crop_sure);
                ...
                if (isWallpaper) {
                    ...
                    try {
                        ...
                        Toast.makeText(CropImageActivity.this,
                                getResources().getString(Res.string.error), Toast.LENGTH_LONG).show();
        ...
        mCancle = (TypefaceTextView) findViewById(Res.id.pandora_crop_cancle);
