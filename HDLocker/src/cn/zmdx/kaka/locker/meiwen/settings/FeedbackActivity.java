...
public class FeedbackActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(Res.layout.pandora_feedback_activity);
        mContext = this;
    ...
    private void initView() {
        mListView = (ListView) findViewById(Res.id.fb_reply_list);
        sendBtn = (BaseButton) findViewById(Res.id.fb_send_btn);
        inputEdit = (EditText) findViewById(Res.id.fb_send_content);
        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(Res.id.fb_reply_refresh);
            ...
            if (convertView == null) {
                ...
                if (Reply.TYPE_DEV_REPLY.equals(reply.type)) {
                    ...
                    convertView = LayoutInflater.from(mContext).inflate(
                            Res.layout.custom_fb_dev_reply, null);
                } else {
                    // 用户的反馈、回复
                    convertView = LayoutInflater.from(mContext).inflate(
                            Res.layout.custom_fb_user_reply, null);
                }

                // 创建ViewHolder并获取各种View
                holder = new ViewHolder();
                holder.replyContent = (TextView) convertView.findViewById(Res.id.fb_reply_content);
                holder.replyProgressBar = (ProgressBar) convertView
                        .findViewById(Res.id.fb_reply_progressBar);
                holder.replyStateFailed = (ImageView) convertView
                        .findViewById(Res.id.fb_reply_state_failed);
                holder.replyData = (TextView) convertView.findViewById(Res.id.fb_reply_date);
