...
import cn.zmdx.kaka.locker.meiwen.R;
 ...
 * 
 * @attr ref android.Res.styleable#KeyboardView_keyBackground
 * @attr ref android.Res.styleable#KeyboardView_keyPreviewLayout
 * @attr ref android.Res.styleable#KeyboardView_keyPreviewOffset
 * @attr ref android.Res.styleable#KeyboardView_labelTextSize
 * @attr ref android.Res.styleable#KeyboardView_keyTextSize
 * @attr ref android.Res.styleable#KeyboardView_keyTextColor
 * @attr ref android.Res.styleable#KeyboardView_verticalCorrection
 * @attr ref android.Res.styleable#KeyboardView_popupLayout
 */
public class KeyboardView extends View implements View.OnClickListener {
    ...
    private boolean mDisambiguateSwipe = true;//TODO change
    ...
    public KeyboardView(Context context, AttributeSet attrs) {
        this(context, attrs, Res.attr.keyboardViewStyle);
    }
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a =
            context.obtainStyledAttributes(
                attrs, Res.styleable.KeyboardView, defStyle, 0);
        ...
        for (int i = 0; i < n; i++) {
            ...
            case R.styleable.KeyboardView_popupLayout:
                ...
                break;
//            case Res.styleable.KeyboardView_shadowColor:
//                mShadowColor = a.getColor(attr, 0);
//                break;
//            case Res.styleable.KeyboardView_shadowRadius:
...
//                com.android.internal.Res.styleable.Theme);
//        mBackgroundDimAmount = a.getFloat(android.Res.styleable.Theme_backgroundDimAmount, 0.5f);
...
//                com.android.internal.Res.bool.config_swipeDisambiguation);
            ...
            if (speakPassword || mAudioManager.isBluetoothA2dpOn()
                ...
                switch (code) {
                    case Keyboard.KEYCODE_ALT:
                        text = getContext().getString(Res.string.keyboardview_keycode_alt);
                        break;
                    case Keyboard.KEYCODE_CANCEL:
                        text = getContext().getString(Res.string.keyboardview_keycode_cancel);
                        break;
                    case Keyboard.KEYCODE_DELETE:
                        text = getContext().getString(Res.string.keyboardview_keycode_delete);
                        break;
                    case Keyboard.KEYCODE_DONE:
                        text = getContext().getString(Res.string.keyboardview_keycode_done);
                        break;
                    case Keyboard.KEYCODE_MODE_CHANGE:
                        text = getContext().getString(Res.string.keyboardview_keycode_mode_change);
                        break;
                    case Keyboard.KEYCODE_SHIFT:
                        text = getContext().getString(Res.string.keyboardview_keycode_shift);
                        break;
                    case '\n':
                        text = getContext().getString(Res.string.keyboardview_keycode_enter);
                        break;
                    default:
                ...
                text = getContext().getString(Res.string.keyboard_headset_required_to_hear_password);
            } else {
                text = getContext().getString(Res.string.keyboard_password_character_no_headset);
            }
...
//                        Res.id.pandora_keyboard_view);
//                View closeButton = mMiniKeyboardContainer.findViewById(
//                        com.android.internal.Res.id.closeButton);
