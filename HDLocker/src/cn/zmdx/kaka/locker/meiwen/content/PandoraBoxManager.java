...
import cn.zmdx.kaka.locker.meiwen.content.box.FoldableBoxAdapter;
import cn.zmdx.kaka.locker.meiwen.content.box.FoldablePage;
import cn.zmdx.kaka.locker.meiwen.content.box.IFoldablePage;
import cn.zmdx.kaka.locker.meiwen.content.box.IPandoraBox;
import cn.zmdx.kaka.locker.meiwen.content.box.IPandoraBox.PandoraData;
...
public class PandoraBoxManager {
    ...
    public IPandoraBox getDefaultBox() {
        ...
        pd.setmImage(BitmapFactory.decodeResource(mContext.getResources(),
                Res.drawable.pandora_box_default));
