...
public class PlainTextBox implements IPandoraBox {
    ...
    public PlainTextBox(Context context, PandoraData data) {
        mData = data;
        mEntireView = LayoutInflater.from(context).inflate(Res.layout.pandora_box_plain_text, null);
        mTextView1 = (TextView) mEntireView.findViewById(Res.id.text1);
        mTextView2 = (TextView) mEntireView.findViewById(Res.id.text2);
    }
