...
public class OnlineWallpaperManager {
    ...
    public void setOnlineWallpaperItem(Context mContext, final ViewGroup mOnlineContainer,
        ...
        ImageView mWallpaperSelect = (ImageView) mWallpaperRl
                .findViewById(Res.id.pandora_wallpaper_item_select);
        final ImageView mWallpaperDel = (ImageView) mWallpaperRl
                .findViewById(Res.id.pandora_wallpaper_item_delete);
        ...
        mWallpaperIvRl.setBackgroundResource(Res.drawable.setting_wallpaper_border_default);
        ...
        int width = (int) mContext.getResources().getDimension(Res.dimen.pandora_wallpaper_width);
        int height = (int) mContext.getResources().getDimension(Res.dimen.pandora_wallpaper_height);
        params.width = width;
        ...
        int layoutWidth = (int) mContext.getResources().getDimension(
                Res.dimen.pandora_wallpaper_layout_width);
