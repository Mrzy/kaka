 ...
 * @since 2014-09-24
 */
public class SwitchButtonUtil implements Cloneable {
     ...
     */
    private int mThumbMarginTop = 0, mThumbMarginBottom = 0, mThumbMarginLeft = 0,
            mThumbMarginRight = 0;
    ...
    private SwitchButtonUtil() {
    };

    public static SwitchButtonUtil getDefault(float density) {
        SwitchButtonUtil defaultConfiguration = new SwitchButtonUtil();
