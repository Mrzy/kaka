...
public class SlidingPaneLayout extends ViewGroup {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if (canSlide && child != mSlideableView) {
                    ...
                    if (canSlide) {
                        ...
                        final int childWidthSpec = MeasureSpec.makeMeasureSpec(measuredWidth
                                + addedWidth, MeasureSpec.EXACTLY);
                        child.measure(childWidthSpec, childHeightSpec);
                    }
                }
            }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (lp.slideable) {
                ...
                final int range = Math.min(nextXStart, width - paddingEnd - mOverhangSize) - xStart
                        - margin;
                mSlideRange = range;
     ...
     */
    @Deprecated
    public void setShadowResource(@DrawableRes
    int resId) {
    ...
    static class SlidingPanelLayoutImplJB extends SlidingPanelLayoutImplBase {
        /*
         * Private API hacks! Nasty! Bad! In Jellybean, some optimizations in
         * the hardware UI renderer prevent a changed Paint on a View using a
         * hardware layer from having the intended effect. This twiddles some
         * internal bits on the view to force it to recreate the display list.
         */
