...
public class AnimatorBuilder {
    ...
    public AnimatorBuilder applyScale(final View viewToScale, float scaleX, float scaleY,
        ...
        AnimatorBundle animatorScale = AnimatorBundle.create(AnimatorBundle.TypeAnimation.SCALE,
                viewToScale, interpolator, scaleX, scaleY);
    ...
    public AnimatorBuilder applyTranslation(final View viewToTranslate, final float translateX,
    ...
    public AnimatorBuilder applyTranslation(final View viewToTranslate, final float translateX,
            final float translateY, final Interpolator interpolator) {

        if (viewToTranslate == null) {
            throw new RuntimeException("You passed a null view");
        }

        AnimatorBundle animatorTranslation = AnimatorBundle.create(
                AnimatorBundle.TypeAnimation.TRANSLATION, viewToTranslate, interpolator,
    ...
    public AnimatorBuilder applyFade(final View viewToFade, final float startFade,
            final float endFade, final Interpolator interpolator) {
        if (viewToFade == null) {
            throw new RuntimeException("You passed a null view");
        }
        mListAnimatorBundles.add(AnimatorBundle.create(AnimatorBundle.TypeAnimation.FADE,
                viewToFade, interpolator, startFade, endFade));
        return this;
    }
     ...
     * @param velocityParallax the velocity to apply to the view in order to
     *            show the parallax effect. choose a velocity between 0 and 1
     *            for better results
     * @return
     */
    public AnimatorBuilder applyVerticalParallax(final View viewToParallax,
            final float velocityParallax) {

        if (viewToParallax == null) {
            throw new RuntimeException("You passed a null view");
        }

        mListAnimatorBundles.add(AnimatorBundle.create(AnimatorBundle.TypeAnimation.PARALLAX,
                viewToParallax, null, -velocityParallax));
    ...
    public AnimatorBuilder applyVerticalParallax(final View viewToParallax) {
        ...
        mListAnimatorBundles.add(AnimatorBundle.create(AnimatorBundle.TypeAnimation.PARALLAX,
                viewToParallax, null, -DEFAULT_VELOCITY_PARALLAX));
            ...
            if (newAnimator.mView == animator.mView) {
                ...
                if (animatorScale != null) {
                    Float translationX = (Float) animatorTranslation.mValues[0]
                            - ((float) animatorTranslation.mView.getWidth()
                                    * (Float) animatorScale.mValues[0] / 2f);
                    Float translationY = (Float) animatorTranslation.mValues[1]
                            - ((float) animatorTranslation.mView.getHeight()
                                    * (Float) animatorScale.mValues[1] / 2f);
    ...
    protected void animateOnScroll(final float boundedRatioTranslationY, final float translationY) {
        ...
        for (AnimatorBuilder.AnimatorBundle animatorBundle : mListAnimatorBundles) {
            ...
            switch (animatorBundle.mTypeAnimation) {
                ...
                case FADE:
                    animatorBundle.mView
                            .setAlpha((((Float) animatorBundle.mValues[1] - (Float) animatorBundle.mValues[0]) * animatorBundle.mInterpolator
                                    .getInterpolation(boundedRatioTranslationY))
                                    + (Float) animatorBundle.mValues[0]); // TODO
                                                                          // performance
                                                                          // issues?
                    break;

                case TRANSLATION:
                    animatorBundle.mView.setTranslationX((Float) animatorBundle.mValues[0]
                            * animatorBundle.mInterpolator
                                    .getInterpolation(boundedRatioTranslationY));
                    animatorBundle.mView
                            .setTranslationY(((Float) animatorBundle.mValues[1] * animatorBundle.mInterpolator
                                    .getInterpolation(boundedRatioTranslationY)) - translationY);
                    break;

                case SCALE:
                    animatorBundle.mView.setScaleX(1f
                            - (Float) animatorBundle.mValues[0]
                            * animatorBundle.mInterpolator
                                    .getInterpolation(boundedRatioTranslationY));
                    animatorBundle.mView.setScaleY(1f
                            - (Float) animatorBundle.mValues[1]
                            * animatorBundle.mInterpolator
                                    .getInterpolation(boundedRatioTranslationY));
                    break;

                case PARALLAX:
                    animatorBundle.mView.setTranslationY((Float) animatorBundle.mValues[0]
                            * translationY);
                    break;
    ...
    public static class AnimatorBundle {
        ...
        public static AnimatorBundle create(final AnimatorBundle.TypeAnimation typeAnimation,
                final View view, final Interpolator interpolator, final Object... values) {
